  ...
  return (
    <div className="container">
      ...
      <legend>Stack</legend>
        ...
        <input type="text" placeholder="Add a task to stack" onKeyDown={newTaskHandler} className='stack-input' autoFocus />
      </fieldset>

      <fieldset className="task-list">
        <legend>Heap</legend>
        <input type="text" placeholder="Add a task to heap" onKeyDown={newHeapHandler} className='heap-input' />
        <ul>
          <>
            {console.log('2', heap)}
