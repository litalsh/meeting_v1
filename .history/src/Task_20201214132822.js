...
const task = (props) => {
  ...
  <li className={props.class}  key={props.id} onDoubleClick={props.move}>
    <input type="range" className={props.slider} min="1" max="20" defaultValue={props.duration} step="1" onMouseUp={props.sliderControl} onChange={e=>props.change(e.target.value)} />
